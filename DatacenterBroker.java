...
public class DatacenterBroker extends SimEntity {
	...
	protected void submitCloudlets() {
		int vmIndex = 0;
		ArrayList <Cloudlet> sortList= new ArrayList<Cloudlet>();
	...
	int totalCloudlets= tempList.size();
		for(int i=0;i<totalCloudlets;i++)
		{
			...
			{
				if(smallestCloudlet.getCloudDeadline() > checkCloudlet.getCloudDeadline())
				{
		...
		{
			Log.printLine(count+".Cloudler Id:"+printCloudlet.getCloudletId()+",Cloudlet Length:"+printCloudlet.getCloudletLength()+",Cloudlet Deadline:"+printCloudlet.getCloudDeadline());
			count++;
		}
