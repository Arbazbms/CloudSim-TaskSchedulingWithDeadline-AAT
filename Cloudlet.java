...
public class Cloudlet {
	...
	private long cloudDeadline;
	private long cloudProfit;
	/**
	...
	public Cloudlet(
			...
			final long cloudDeadline,
			final long cloudProfit,
			final int pesNumber,
	...
	public Cloudlet(
		...
		this.cloudDeadline = Math.max(1, cloudDeadline);
		this.cloudProfit = Math.max(1, cloudProfit);
	...
	public boolean setCloudDeadline(final long cloudDeadline) {
		if(cloudDeadline <= 0) {
			return false;
		}
	...
	public boolean setCloudProfit(final long cloudProfit) {
		if(cloudProfit <= 0) {
			return false;
		}
		
		this.cloudProfit = cloudProfit;
		return true;
	}
	/**
